...
//-----------------------------------------------
void BinaCPP_logger::write_log(const char *fmt, ...)
{
    if (debug_level == 0)
    {
        return;
...
void BinaCPP_logger::write_log_clean(const char *fmt, ...)
{
    if (debug_level == 0)
    {
        return;
...
//---------------------
void BinaCPP_logger::open_logfp_if_not_opened()
{
...
//---------------------
void BinaCPP_logger::set_debug_level(int level)
{
    debug_level = level;
}

//--------------------
void BinaCPP_logger::set_debug_logfile(string &pDebug_log_file)
{
    debug_log_file = pDebug_log_file;
}

//--------------------
void BinaCPP_logger::enable_logfile(int pDebug_log_file_enable)
{
